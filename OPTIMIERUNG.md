...
| **Video-Abrufe** *(neu 10.09.2026)* | `py _scripts/youtube_abrufe.py` → `_analytics/youtube_history.jsonl` | **15** Anwendung (seit 02.09.) · **24** Pitch (seit 30.07.) · **51** Prozessdatenauswertung (seit 02/2025) *(Stand 10.09.2026)* | steigend |
